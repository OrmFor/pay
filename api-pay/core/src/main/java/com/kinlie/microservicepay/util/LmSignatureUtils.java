...
public class LmSignatureUtils {
	...
	public static byte[] sign(LmSignatureAlgorithm algorithm, PrivateKey privateKey,
			String data)
	...
	public static boolean verify(LmSignatureAlgorithm algorithm, PublicKey publicKey,
	...
	public static boolean verify(LmSignatureAlgorithm algorithm, PublicKey publicKey, byte[] data,
