...
public class StringUtil extends StringUtils {
	...
	public static boolean isPhone(String phone) {
		phone = isNull(phone);
		Pattern regex = Pattern.compile("^((13[0-9])|(15[^4,\\D])|(17[0-9])|(18[0-9])|(147))\\d{8}$");
	...
	/**
	 * 判断字符串是否为数字 String a = "A10"; -- false String b = "0.1230"; -- true String
	 * c = "-1.256"; -- true String e = "-1"; -- true String d = "125"; -- true
	 *
	 * @param str
	 * @return
	 */
