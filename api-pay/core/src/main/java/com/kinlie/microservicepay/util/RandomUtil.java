...
public class RandomUtil {
	...
	/**
	 * 
	 * @Title: getRndGoodsCode
	 * @Description: 抽取
	 * @author wzq
	 * @date 2017年5月16日 下午5:25:28
	 * @version V1.0
	 * @param @param luckDrawGoodsCJArray
	 * @param @return
	 * @return String
	 */
	public static String getRndGoodsCode(List<String> luckDrawGoodsCJArray) {
		int rndPos = R.nextInt(luckDrawGoodsCJArray.size());// 随机坐标
		return luckDrawGoodsCJArray.get(rndPos);
	}
