...
public class HttpUtil {
	...
	public static byte[] get(String url, Map<String, Object> ParamMap,
		...
		try {
			...
			byte[] content = EntityUtils.toByteArray(execute.getEntity());
			LOGGER.debug(url);
	...
	public static String getMethodUrl(String url, Map<String, Object> ParamMap,
							 Map<String, String> headerParamMap,
							 boolean isSSL) {
		try {
			if ((ParamMap != null) && (ParamMap.size() > 0)) {
