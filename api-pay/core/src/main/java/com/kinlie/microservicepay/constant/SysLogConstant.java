...
public class SysLogConstant {
	...
	public static final String OPRATE_LOGIN = "登录";
	...
	public static final String OPRATE_LEAVE = "离职";
	public static final String OPRATE_RESET_PWD = "重置登录密码";
	public static final String OPRATE_MODIFY_PWD = "修改登录密码";
	...
	public static final String OPRATE_TRANSFER = "转账";
